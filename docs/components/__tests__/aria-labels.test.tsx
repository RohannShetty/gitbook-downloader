    ...
    assets: [
      {
        ...
        size: 34500000,
        downloadCount: 520,
      browserDownloadUrl: 'https://github.com/RohannShetty/gitbook-downloader/releases/download/v11.0.5/docharvest-windows-latest.exe',
        os: 'windows',
      },
      {
        ...
        size: 48300000,
        downloadCount: 210,
      browserDownloadUrl: 'https://github.com/RohannShetty/gitbook-downloader/releases/download/v11.0.5/docharvest-ubuntu-latest',
        os: 'linux',
      },
      {
        ...
        size: 30400000,
        downloadCount: 290,
      browserDownloadUrl: 'https://github.com/RohannShetty/gitbook-downloader/releases/download/v11.0.5/docharvest-macos-latest',
        os: 'macos',
      },
    ],
  },
