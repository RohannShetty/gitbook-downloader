...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-sky-500 to-cyan-500 text-white shadow hover:from-sky-400 hover:to-cyan-400 hover:shadow-cyan-500/20 hover:shadow-lg",
        destructive:
        ...
        emerald: "bg-gradient-to-r from-emerald-600 to-teal-500 text-white shadow hover:from-emerald-500 hover:to-teal-400 hover:shadow-emerald-500/20 hover:shadow-lg",
      },
      size: {
